CREATE TABLE `General` (
  ...
  `CeildihComplete` tinyint(4) NOT NULL,
  `SessionComplete` tinyint(4) NOT NULL,
  `WorkshopComplete` tinyint(4) NOT NULL,
  `ConcertComplete` tinyint(4) NOT NULL,
  `FamilyComplete` tinyint(4) NOT NULL,
  `ComedyComplete` tinyint(4) NOT NULL,
  `CraftComplete` tinyint(4) NOT NULL,
  `SpecialComplete` tinyint(4) NOT NULL,

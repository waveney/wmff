...
<html lang="en">
<head>
<title>Wimborne Minster Folk Festival | Ceilidh Bands</title>
...
<a href="/" rel="bookmark"><h1>Wimborne Minster Folk Festival | Ceilidh Bands</h1></a>
<div class="navigation"><?php include("files/navigation.php"); ?></div>
<div class="content">

<h2 class="maintitle">Ceilidh Bands</h2>

<p>Our ceilidh bands will get you up and swinging around at this year's folk festival!</p>
...
$eventresult = mysql_query("SELECT * FROM wmffevent WHERE cat='ceilidh' AND display='true' ORDER BY title ASC");

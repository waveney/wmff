...
<html lang="en">
<head>
<title>Wimborne Minster Folk Festival | Family Activities</title>
...
<a href="/" rel="bookmark"><h1>Wimborne Minster Folk Festival | Family Activities</h1></a>
<div class="navigation"><?php include("files/navigation.php"); ?></div>
<div class="content">

<h2 class="maintitle">2017 Family Activities</h2>
<p>We take passion in providing fantastic facilities and entertainment for all the family, right across the town in designated family areas. Check back soon to see what other activities we have to offer around the town!</p>
...
$eventresult = mysql_query("SELECT * FROM wmffevent WHERE cat='family' AND display='true' ORDER BY title ASC");

...
<html lang="en">
<head>
<title>Wimborne Minster Folk Festival | Workshops</title>
...
<a href="/" rel="bookmark"><h1>Wimborne Minster Folk Festival | Workshops</h1></a>
<div class="navigation"><?php include("files/navigation.php"); ?></div>
<div class="content">

<h2 class="maintitle">2017 Workshops</h2>
<p>A selection of workshops to take part in around the town.</p>
...
$eventresult = mysql_query("SELECT * FROM wmffevent WHERE cat='workshop' AND display='true' ORDER BY title ASC");

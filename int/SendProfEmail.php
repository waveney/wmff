...
if (isset($_POST['PREVIEW'])) {
  ...
  echo "<div style='background:white;border:2;border-color:blue;padding:20;margin:20;width:90%;height:50%' >$MessP</div>";
}
echo "<h3>Edit the message below, then click send or cancel</h3>";

...
<h3>BACKGROUND</h3>
A sophisticated database and website is being developed for Wimborne Minster Folk Festival, using experence and knowledge from providing facilities for many events (Folk Festivals and Science
Fiction Conventions) over many years.  It is going to be of considerable use to other festivals in the future.<p>
...
<li>Timeline management - who is doing what and when, also recuring tasks
<li>Music management - records of artists, contracts and their programmes.  (Not as full feature as dance at the moment)
...
<li>News and front page article management - a CMS to manage what appears and when
<li>Galleries - steup, import, crop, caption photos
...
This sits on top of a large database with everything stored in it.<p>

This is available as a number of separate packages, dance, music, documents, timeline, trade etc.<p>

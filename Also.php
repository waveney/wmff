<?php
  ...
  dohead("Other Events Run by the Wimborne Minster Folk Festival");

?>
<h2 class=subtitle>Other Events Run by the Wimborne Minster Folk Festival</h2>
The following lead up to the folk festival:<p>
...
<h2 class=subtitle><a href=LiveNLoud>Live and Loud</a></h3> 
<strong>Live and Loud</strong> has been running for several years now with the intention of finding local talent from 
...
<a href=LiveNLoud>More Info and Application Form</a><p> 

<br clear=all>
<div class="minibiodiv">
<img src="/images/Noel-James-2017.jpg" alt="Wimborne Minster Folk Festival" class="bioimg" />
<p>Join the comedy billing at the folk festival!</p>
</div>
<h2 class=subtitle>Laugh Out Loud</h3>
Are you funny? Do you want a chance to prove it - on stage, in front of a warm, supportive audience? 
If your answer is a great big "YES!" then our "<strong>Laugh Out Loud</strong>" New Act Competition is just right for you.<p>
	
2018 Details to follow<p>

<br clear=all>
<h2 class=subtitle><a href=/BuskersBash>Buskers Bash</a></h3>
...
<a href=/BuskersBash>More Info and Application Form</a><p> 
<?php 
  dotail();
?>

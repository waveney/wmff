<?php 
  ...
  Set_User();
  session_start();
  if (isset($_COOKIE{'WMFF'}) || isset($_SESSION{'WMFFid'})) {
    echo "<ul id=staffmenu>";
    echo "<li><a style='color:#FFFFFF;' class=staffnavbutton href=/int/Staff.php>Staff Tools</a></li>";
    if (!isset($USER{Subtype})) {
      echo "<li><a style='color:#FFFFFF;' class=staffnavbutton href=/int/Dir.php>Docs</a></li>";
      if (Access('Committee','OldAdmin')) {
        echo "<li><a style='color:#FFFFFF;' class=staffnavbutton href=/admin>Old Admin</a></li>";
      }
      echo "<li><a href='/int/Login.php?ACTION=LOGOUT' class='staffnavbutton'>Logout " . $USER['Login'] . "</a>\n</li>";
    }
    echo "</ul>";
  }
?>
...
<li><a style="color:#FFFFFF;" class="navbutton" href="/contact" rel="bookmark">Contact</a></li>

...
VALUES ('$nextnumber', 'artisan', '$getbusiness', '$getcontactname', '$getinvoiceaddress', '$getemail', '$getphone', '$getproducts', '$getpitchsize', '$gethealth', '$getcharity', '$getbidlevy', '$getchamber', '$getfestivaltrader', '$getrisk', '$getinsurance', '$getesig', 'unconfirmed', '$getdatetime', '2017')");
...
<tr><th colspan=\"2\" style=\"background-color:#a30046; color:#FFFFFF; text-align:left; padding:10px 5px; font-size:18px;\">Trade Application: ARTISAN</th></tr>
...
$headers .= "Content-Type: text/html; charset=ISO-8859-1\r\n";
  ...
  mail( "treasurer@wimbornefolk.co.uk", "Trade Application: ARTISAN",
  $message, "$headers" );
